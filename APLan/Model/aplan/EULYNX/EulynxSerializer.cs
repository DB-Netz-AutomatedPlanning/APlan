...
namespace aplan.eulynx
{
    ...
    class EulynxSerializer
    {
        ...
        private readonly Dictionary<string, string> xmlnsDict = new Dictionary<string, string>
        {
            ...
            //V1.0
            //{"xsi", @"http://www.w3.org/2001/XMLSchema-instance" },
            //{"generic", @"http://dataprep.eulynx.eu/schema/Generic/1.0" },
            //{"sig", @"http://dataprep.eulynx.eu/schema/Signalling/1.0"},
            //{"db",@"http://dataprep.eulynx.eu/schema/DB/1.0" },
            //{"sncf",@"http://dataprep.eulynx.eu/schema/SNCF/1.0" },
            //{"nr",@"http://dataprep.eulynx.eu/schema/NR/1.0" },
            //{"prorail",@"http://dataprep.eulynx.eu/schema/ProRail/1.0" },
            //{"rfi",@"http://dataprep.eulynx.eu/schema/RFI/1.0" },
            //{"trv",@"http://dataprep.eulynx.eu/schema/TRV/1.0" },
            ...
            //V1.1
            {"xsi", @"http://www.w3.org/2001/XMLSchema-instance" },
            {"generic", @"http://dataprep.eulynx.eu/schema/Generic/1.1" },
            {"sig", @"http://dataprep.eulynx.eu/schema/Signalling/1.1"},
            {"db",@"http://dataprep.eulynx.eu/schema/DB/1.1" },
            {"sncf",@"http://dataprep.eulynx.eu/schema/SNCF/1.1" },
            {"nr",@"http://dataprep.eulynx.eu/schema/NR/1.1" },
            {"prorail",@"http://dataprep.eulynx.eu/schema/ProRail/1.1" },
            {"rfi",@"http://dataprep.eulynx.eu/schema/RFI/1.1" },
            {"trv",@"http://dataprep.eulynx.eu/schema/TRV/1.1" },

            {"rsmCommon", @"http://www.railsystemmodel.org/schemas/Common/202206"},
            {"rsmNE", @"http://www.railsystemmodel.org/schemas/NetEntity/202206"},
            {"rsmTrack", @"http://www.railsystemmodel.org/schemas/Track/202206" },
            {"rsmSig", @"http://www.railsystemmodel.org/schemas/Signalling/202206"}
        };
