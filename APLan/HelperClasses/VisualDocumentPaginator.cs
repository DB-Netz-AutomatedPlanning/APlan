...
namespace APLan.HelperClasses
{
    public class VisualDocumentPaginator : DocumentPaginator
    {
        ...
        private int m_PageCountX;
        private int m_PageCountY;
        ...
        public VisualDocumentPaginator(DocumentPaginator paginator, Size pageSize, Size margin)
        {
            ...
            m_PageCountY = (int)Math.Floor(m_Paginator.PageSize.Height / m_ContentSize.Height);
            m_PageCountX = (int)Math.Floor(m_Paginator.PageSize.Width / m_ContentSize.Width);
            m_PageCount = m_PageCountX * m_PageCountY;
        ...
        {
            int pageNumberX = pageNumber / m_PageCountY;
            int pageNumberY = pageNumber % m_PageCountY;
            ...
            using (DrawingContext ctx = title.RenderOpen())
            {
                ...
                FormattedText text = new FormattedText("Page " + (pageNumber + 1) + " of " + m_PageCount,System.Globalization.CultureInfo.CurrentCulture, FlowDirection.LeftToRight,typeface, 14, Brushes.Black);
            ...
            RectangleGeometry clip = new RectangleGeometry(
                              new Rect(m_ContentSize.Width * pageNumberX,
                                       m_ContentSize.Height * pageNumberY,
                                       m_ContentSize.Width,
                                       m_ContentSize.Height));
            m_PageContent.Clip = clip;
            m_PageContent.Transform = new TranslateTransform(
                                  -m_ContentSize.Width * pageNumberX,
                                  -m_ContentSize.Height * pageNumberY);
            m_SmallerPage.Children.Add(m_PageContent);
            m_SmallerPage.Transform = new ScaleTransform(1,1);
