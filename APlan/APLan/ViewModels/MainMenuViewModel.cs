...
namespace APLan.ViewModels
{
    public class MainMenuViewModel : BaseViewModel
    {
        ...
        {
            var aplanviewModel = System.Windows.Application.Current.FindResource("aplanCADViewerViewModel") as AplanCADViewerViewModel;
            var initialColor = aplanviewModel.SelectedColorForACAD;
            var dialog = new ColorPickerDialog(initialColor);
            var result = dialog.ShowDialog();
            if (result.HasValue && result.Value)
            {
                aplanviewModel.SelectedColorForACAD = dialog.Color;
            }
        }
